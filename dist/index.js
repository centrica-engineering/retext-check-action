...
module.exports = eval("require")("./helpers/github");
...
/* harmony import */ var _helpers_github__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(2506);
/* harmony import */ var retext__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(6959);
/* harmony import */ var to_vfile__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(1838);
/* harmony import */ var retext_spell__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(8755);
/* harmony import */ var retext_english__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(6206);
/* harmony import */ var retext_contractions__WEBPACK_IMPORTED_MODULE_5__ = __nccwpck_require__(4262);
/* harmony import */ var retext_equality__WEBPACK_IMPORTED_MODULE_6__ = __nccwpck_require__(1901);
/* harmony import */ var retext_readability__WEBPACK_IMPORTED_MODULE_7__ = __nccwpck_require__(7746);
/* harmony import */ var retext_repeated_words__WEBPACK_IMPORTED_MODULE_8__ = __nccwpck_require__(2346);
/* harmony import */ var retext_indefinite_article__WEBPACK_IMPORTED_MODULE_9__ = __nccwpck_require__(8488);
/* harmony import */ var retext_stringify__WEBPACK_IMPORTED_MODULE_10__ = __nccwpck_require__(7715);
/* harmony import */ var dictionary_en_gb__WEBPACK_IMPORTED_MODULE_11__ = __nccwpck_require__(7161);
/* harmony import */ var vfile_reporter__WEBPACK_IMPORTED_MODULE_12__ = __nccwpck_require__(8366);
...
(async () => {
  const filesChanged = await (0,_helpers_github__WEBPACK_IMPORTED_MODULE_0__.getChangedFiles)(octokit, repo, owner);

  filesChanged.forEach((PRFile) => {
    if (PRFile.endsWith('.md') || PRFile.endsWith('.markdown')) {
      retext__WEBPACK_IMPORTED_MODULE_1__()
        .use(retext_english__WEBPACK_IMPORTED_MODULE_4__)
        .use(retext_equality__WEBPACK_IMPORTED_MODULE_6__)
        .use(retext_contractions__WEBPACK_IMPORTED_MODULE_5__)
        .use(retext_readability__WEBPACK_IMPORTED_MODULE_7__, { age: 20 })
        .use(retext_spell__WEBPACK_IMPORTED_MODULE_3__, { dictionary: dictionary_en_gb__WEBPACK_IMPORTED_MODULE_11__, normalizeApostrophes: false, max: 100 })
        .use(retext_repeated_words__WEBPACK_IMPORTED_MODULE_8__)
        .use(retext_indefinite_article__WEBPACK_IMPORTED_MODULE_9__)
        .use(retext_stringify__WEBPACK_IMPORTED_MODULE_10__)
        .process(to_vfile__WEBPACK_IMPORTED_MODULE_2__.readSync(PRFile), (err, file) => {
          const body = vfile_reporter__WEBPACK_IMPORTED_MODULE_12__(err || file);
          console.error(body);
